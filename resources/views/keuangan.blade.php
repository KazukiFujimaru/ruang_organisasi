                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center ms-1">
                                                        <h6 class="mb-0 text-sm font-weight-semibold">{{ $keuangan->nama}}</h6>
                                            ...
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">{{ $keuangan->jenis}}</p>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-sm font-weight-normal">{{ $keuangan->tanggal}}</span>
                                            </td>
