...
<div class="sidenav-header">
        ...
        <ul class="navbar-nav">
        <li class="nav-item">
                <a class="nav-link  {{ is_current_route('profile-organisasi') ? 'active' : '' }}"
                    href="{{ route('profile-organisasi') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>profile-organisasi</title>
                            <g id="profile-organisasi" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('view-proker') ? 'active' : '' }}" href="{{ route('view-proker') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>proker</title>
                            <g id="proker" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('view-keuangan') ? 'active' : '' }}" href="{{ route('view-keuangan') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('view-surat') ? 'active' : '' }}" href="{{ route('view-surat') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('view-inventaris') ? 'active' : '' }}" href="{{ route('view-inventaris') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('view-lpj') ? 'active' : '' }}" href="{{ route('view-lpj') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
